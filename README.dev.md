# `langchain_surf` developer documentation
...
# install langchain_surf as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `langchain_surf`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d langchain_surf.XXXXXX)
git clone git@github.com:SURF-Research-Agents/langchain_surf .
...
Visit
[https://test.pypi.org/project/langchain_surf](https://test.pypi.org/project/langchain_surf)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d langchain_surf-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple langchain_surf
```
...
Don't forget to also make a [release on GitHub](https://github.com/SURF-Research-Agents/langchain_surf/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.